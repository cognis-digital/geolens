#!/usr/bin/env sh
# Universal installer for geolens. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/geolens.git"
echo "Installing geolens ..."
